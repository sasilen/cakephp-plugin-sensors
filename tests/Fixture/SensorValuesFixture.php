<?php
namespace Sensors\Test\Fixture;
 ...
 *
 */
class SensorValuesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'sensor_id' => ['type' => 'string', 'length' => 15, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            'id' => 1,
            'sensor_id' => 'Lorem ipsum d',
            'datetime' => '2017-04-26 03:36:44',
            'value' => 1,
            'type' => 'Lorem ipsum d'
        ],
    ];
